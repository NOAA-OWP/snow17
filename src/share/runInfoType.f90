...
contains   
  ...
  subroutine Init(this, namelist)
    ...
    this%start_hr     = this%start_datehr(9:10)
    ...
    do nh=1,n_hrus
      ...
      this%output_fileunits(nh)  = 750 + nh       ! allows for 500 non-overlapping fileunits
    end do
    this%output_fileunits(nh)    = 750 + nh + 1   ! add one more for combined ouptuts
