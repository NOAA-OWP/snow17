...
C     SNOW GONE - SET ALL CARRYOVER TO NO SNOW CONDITIONS.
  150 TEX=0.0
      DO 151 N=1,NEXLAG
C 151 TEX=TEX+EXLAG(N)    ! not supported fortran 2018, replace with following 2 lines
      TEX=TEX+EXLAG(N)
  151 END DO 
...
C     SET SIMULATED AESC AND TOTAL WATER-EQUIVALENT.
      TEX=0.0
C     DO 210 N=1,NEXLAG    ! not supported fortran 2018, replace with following 2 lines
      DO N=1,NEXLAG
        TEX=TEX+EXLAG(N)
  210 END DO
